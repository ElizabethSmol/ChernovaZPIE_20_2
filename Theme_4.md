...
Модули это определения функций, классов и переменных. Вариант организации кода на уровне файла и позволяют поделить код на логические компоненты. 
Функции и модули являются базовой составляющей языка программирования Python, организовывая управление сложным кодом, облегчая его.
